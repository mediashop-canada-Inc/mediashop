...
Plugin URI: http://proword.net/Plugins/Vc_Post_Layout/
...
/*
	v4.0 : Fixed : Compatible with New version of VC
		   Fixed : Fixed some minor issues
		   Fixed : Fetch Products

	v3.9 : Update : Order terms of filters
	v3.8 : Update : Compatible with version 5.2
*/
