	...
	class VCExtendAddonClass_GRID  {
			...
			$param_line = '<input name="'.$settings['param_name']
				...
				<script type="text/javascript">
					...
					jQuery(document).ready(function(){
						...
						jQuery(".'.$settings['param_name'].'-simple_font").change(function(){
							value_font=[];
							jQuery("#'.$settings['param_name'].'-simple_font").val("");
			...
			$param_line = '<input name="'.$settings['param_name']
				...
				<script type="text/javascript">
					...
					jQuery(document).ready(function(){
						...
						jQuery(".'.$settings['param_name'].'-adv_font").change(function(){
							value_font=[];
							jQuery("#'.$settings['param_name'].'-adv_font").val("");
		...
		function pw_border_settings_field($settings, $value){
			...
			$param_line = '<input name="'.$settings['param_name']
				 ...
				 .$settings['param_name'].' '.$settings['type'].' '.$settings['class'].'" type="text" value="'.$meta[5].'" ' . $dependency . ' style="max-width:50px; margin-right: 10px;" data-default-color="#7C7C7C"/>
		...
		*/
		...
		public function excerpta($text,$excerpt_length,$content_type='excerpt') {
			global $post;
			if(trim($excerpt_length)=='') $excerpt_length=10;
			$limit=$excerpt_length;
			if($content_type=='excerpt')	
