...
function nimmo_widgets_init()
{
    ...
    register_sidebar(array(
        'name'          => esc_html__('Upper Header', 'nimmo'),
        'id'            => 'upper-header',
        'description'   => esc_html__('Add widgets here.', 'nimmo'),
        'before_widget' => '<section id="%1$s" class="widget %2$s"><div class="widget-content">',
        'after_widget'  => '</div></section>',
...
function nimmo_scripts()
{
    ...
    wp_enqueue_script('tilt', get_template_directory_uri() . '/assets/js/tilt.min.js', array( 'jquery' ), 'all', true);
    ...
    wp_enqueue_script('nimmo-sidebar-fixed', get_template_directory_uri() . '/assets/js/sidebar-scroll-fixed.min.js', array( 'jquery' ), '1.0.0', true);
    wp_enqueue_script('magnific-popup', get_template_directory_uri() . '/assets/js/magnific-popup.min.js', array('jquery'), '1.0.0', true);
    wp_enqueue_script('nimmo-main', get_template_directory_uri() . '/assets/js/main.min.js', array('jquery'), $theme->get('Version'), true);
    wp_register_script('nimmo-carousel', get_template_directory_uri() . '/assets/js/ct-carousel.min.js', array('jquery'), $theme->get('Version'), true);
