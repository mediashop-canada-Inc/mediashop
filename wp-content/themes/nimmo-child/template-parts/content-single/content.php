...
<article id="post-<?php the_ID(); ?>" <?php post_class('single-hentry'); ?>>
    <div class="entry-blog">
        ...
        <div class="member-details">
           <span class="member-bio"> Name : </span><?php the_title();?><br>
           <span class="member-bio"> Job Title :</span> <?php the_field('job_title');?><br>
           <span class="member-bio"> Location : </span><?php the_field('location');?><br>
           <span class="member-bio"> Developer Type :</span> <?php the_field('type');?><br>
           <span class="member-bio"> Rate Per Hour :</span> <?php the_field('rate_per_hour');?><br>
        </div>
        <?php } ?>
